...
const operationFacts = [["약 60명", "일정에 맞춘 인력 배정"], ["자체 세탁시설", "수거·세탁·분류·재배포"], ["객실별 기록", "사진·이상·비용 내역"]];
const laundrySteps = ["수거", "자체 세탁", "분류·보관", "객실별 재배포"];
