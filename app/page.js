...
const operationRoles = [
  ["calendar", "데스크", "일정 확인 및 현장 조율"],
  ["supply", "배달팀", "현장 전달 지원"],
  ["linen", "배급팀", "객실별 물품 배급"],
  ["laundry", "세탁팀", "세탁 공정 운영"],
  ["broom", "클리너", "객실 청소 진행"],
  ["checklist", "관리감독", "검수 및 상태 확인"],
  ["receipt", "수거팀", "침구·비품 수거"],
];
